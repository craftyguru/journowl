...
function App() {
  ...
  // Demo mode - show account selector or demo dashboards (PRIORITIZE DEMO FIRST)
              ...
              <div className="min-h-screen">
                ...
                <div className="fixed top-4 right-4 z-50 flex gap-2">
                  <button
                    ...
                    className="px-4 py-2 bg-white/10 text-white backdrop-blur-md border border-white/20 rounded-lg hover:bg-white/20 transition-all"
                  >
                    Dashboard
                  </button>
                  <button
                ...
                <main>
                  ...
                  {selectedAccount.type === "user" && <EnhancedDashboard onSwitchToKid={() => {}} />}
