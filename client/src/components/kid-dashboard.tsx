...
import { KidCalendar } from "@/components/kid-dashboard/KidCalendar";
import { KidPhotos } from "@/components/kid-dashboard/KidPhotos";
import { KidAIBuddy } from "@/components/kid-dashboard/KidAIBuddy";
import { KidStats } from "@/components/kid-dashboard/KidStats";
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} defaultValue="write" className="w-full">
          ...
          <TabsContent value="calendar" className="space-y-6">
            <KidCalendar 
              ...
              onDateClear={() => setSelectedCalendarDate(null)}
              onWriteToday={() => openJournalEditor(null, "Write about your day today!")}
            />
          </TabsContent>
...
export { AIStoryMaker, KidAchievements, KidGoals, KidCalendar, KidPhotos, KidAIBuddy, KidStats };