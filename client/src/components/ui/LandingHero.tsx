          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-8xl font-bold bg-gradient-to-r from-amber-400 via-orange-500 to-red-500 bg-clip-text text-transparent drop-shadow-2xl mb-2 sm:mb-4 leading-tight" 
              ...
              <img 
                ...
                className="inline-block w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16 lg:w-20 lg:h-20 mr-2 sm:mr-3 mb-1 sm:mb-2 rounded-full object-cover border-2 border-amber-400 shadow-lg animate-bounce"
              />
              JournOwl
            </h1>
            <motion.div 
