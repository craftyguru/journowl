...
export const users = pgTable("users", {
  ...
  dailyCoinEarned: integer("daily_coin_earned").default(0),
  lastCoinEarnDate: timestamp("last_coin_earn_date"),
  royaltyRank: text("royalty_rank"),
  loyaltyRank: text("loyalty_rank"),
  borderStyle: text("border_style"),
  fontStyle: text("font_style"),
  flareStyle: text("flare_style"),
  titlePrefix: text("title_prefix"),
  titleSuffix: text("title_suffix"),
  storeDiscount: integer("store_discount").default(0),
  discountUsesRemaining: integer("discount_uses_remaining").default(0),
  lastRankLevel: integer("last_rank_level").default(1),
  isSupremeUser: boolean("is_supreme_user").default(false),
  ...
  newsletterVerifiedAt: timestamp("newsletter_verified_at"),
  instagramVerifiedAt: timestamp("instagram_verified_at"),
  twitterVerifiedAt: timestamp("twitter_verified_at"),
  facebookVerifiedAt: timestamp("facebook_verified_at"),
